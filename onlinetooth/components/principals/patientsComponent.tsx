...
export default function PatientsComponents() {
  ...
  // Atualiza o estado para inputs de texto/textarea
  const handleChange = (
  ...
  // Atualiza o estado para rádio de sexo
  const handleSexChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setFormData((prev) => ({ ...prev, sex: e.target.value }));
  };

  // Para selects customizados
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="border-b pb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="responsibleBirthDate">
                    Data de nascimento
                  </Label>
                  <Input
                    type="date"
  ...
  return (
    // Removemos "mx-auto" e usamos "flex-1 h-full"
    <div className="flex-1 h-full w-[88vw] p-4 md:p-6 flex flex-col bg-white">
      {!selectedPatientId && (
        <div className="flex flex-col w-full h-full">
          <div className="flex flex-col sm:flex-row w-full justify-between items-start sm:items-center mb-4 gap-4">
          ...
          <div className="divide-y overflow-auto">
            {patientsData.map((patient) => (
              <div
                key={patient.id}
                className="flex sm:flex-row w-full justify-between items-center sm:items-center py-2"
              >
                <span className="text-gray-800 font-medium">
                  {patient.name}
                </span>
                <Button
                  className="bg-teal-300 hover:bg-teal-400 text-white sm:mt-0"
