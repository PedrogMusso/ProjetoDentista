...
export default function CalendarComponent() {
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Preencha os detalhes da consulta e clique em Marcar.
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="sendReminder">
                Enviar confirmação e lembrete automático
              </Label>
              <Switch
                id="sendReminder"
  ...
  return (
    <div className="flex w-[88vw] h-[88vh] justify-center flex-col space-y-3 p-3">
